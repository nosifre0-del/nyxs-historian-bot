...
# ============================================================
# AI API KEY
# ضع المفتاح بين علامتي الاقتباس أعلاه
# ============================================================

# AI_BASE_URL و AI_MODEL
# يمكن تعديلهما حسب مزود الـ API المستخدم
...
إذا طلب العراقية → استخدم اللهجة العراقية.
...
"""
    ...
    def ask(messages):
        ...
        if not AI_API_KEY:
            ...
            return (
                "🧠 NYXS Intelligence\n\n"
                "لم يتم وضع مفتاح API في السطر الأول من الملف."
            )
